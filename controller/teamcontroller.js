 ...
 * @returns
 */
teamController.createTeam = function (username, userId) {
  return new Promise((resolve, reject) => {
    const teamToAdd = new Team({name: username, admins: [userId], users: [userId]})
    teamToAdd.populate('admin_users').execPopulate() // Necessary if coming from profile page
    teamToAdd.populate('non_admin_users').execPopulate() // Necessary if coming from profile page
